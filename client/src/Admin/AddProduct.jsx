...
const AddProduct = () => {
    ...
    const handleAddProduct = async () => {
        ...
        if (state.isValid) {
            await axiosAPI.post("products/addProduct", state.values).then(response => {
                const add = {
                    type: 'ADD',
            ...
            <div className='flex flex-col lg:flex-row lg:w-[90%] lg:items-center lg:justify-center justify-between gap-5 '>
                ...
                <form className='flex flex-col w-full justify-between text-sm gap-3' onSubmit={(e) => e.preventDefault()}>
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="text" onChange={handleChange} name="productName" className='rounded bg-transparent border border-neutral-300 hover:border-neutral-400 px-3 py-2 focus:outline-none' placeholder='Product Name' />
                    ...
                    <div className='flex flex-col lg:flex-row gap-3 items-start justify-between w-full'>
                        ...
                        <div className='flex flex-col gap-2 w-full min-h-[80px]'>
                            ...
                            <input onChange={handleChange} name="price" type="number" className='rounded bg-transparent border border-neutral-300 hover:border-neutral-400 px-3 py-2 focus:outline-none' placeholder='Price' />
                    ...
                    <div className='flex flex-col lg:flex-row gap-3 items-start justify-between w-full'>
                        <div className='flex flex-col gap-2 w-full min-h-[80px]'>
                            ...
                            <input onChange={handleChange} name="discount" min={0} max={100} type="number" defaultValue={0} className='rounded bg-transparent border border-neutral-300 hover:border-neutral-400 px-3 py-2 focus:outline-none' placeholder='Discount' />
                        </div>
                        <div className='flex flex-col gap-2 w-full min-h-[80px]'>
                            <label htmlFor="quantity" className='font-semibold'>Quantity</label>
                            <input onChange={handleChange} name="quantity" type="number" defaultValue={1} className='rounded bg-transparent border border-neutral-300 hover:border-neutral-400 px-3 py-2 focus:outline-none' placeholder='Quantity' />
                        </div>
                    </div>

                    <div className='flex flex-col gap-2'>
                        <label htmlFor="description" className='font-semibold'>Description</label>
                        <textarea onChange={handleChange} name="description" className='rounded bg-transparent border border-neutral-300 hover:border-neutral-400 px-3 py-2 focus:outline-none resize-none' placeholder='Description Here...'  ></textarea>
                    </div>

                    <div className='flex gap-5'>
                        <button type='button' onClick={handleAddProduct} className='bg-primary text-center md:max-w-40 px-3 py-2 rounded uppercase hover:opacity-80'>Add Product</button>
